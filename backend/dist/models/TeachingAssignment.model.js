...
const TeachingAssignmentSchema = new mongoose_1.Schema({
    teacher_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Teacher', required: true },
...
TeachingAssignmentSchema.index({ teacher_id: 1, subject_id: 1, batch_id: 1, semester: 1 }, { unique: true });
